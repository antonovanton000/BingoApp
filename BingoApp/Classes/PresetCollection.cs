...
public class PresetCollection
{
        ...
        foreach (var folder in folders.Where(i => Path.GetDirectoryName(i) != "Custom"))
        {
            ...
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    preset.LoadSquares();
                    preset.SquareCount = preset.Squares.Count;
    ...
    public static async Task<List<PresetSquare>> GetPresetSquaresByGameAndPresetName(string game, string presetName)
    {
